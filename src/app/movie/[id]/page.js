...
export default async function MoviePage({ params }) {
    ...
    return (
        <div className='w-full'>
            <div className="p-4 md:pt-8 flex flex-col md:flex-row items-center content-center max-w-6xl mx-auto md:space-x6">
                <Image 
                ...
                <div className="p-2">
                    ...
                    <p className='mb-3'><span className='font-semibold mr-1'>Ratings: </span>{movie.vote_count}</p>
                </div>
            </div>
        </div>
    )  
